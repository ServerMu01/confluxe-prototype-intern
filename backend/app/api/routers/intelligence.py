...
def get_trend_signals(
    ...
    return trend_service.get_macro_trends(job_id=job_id, category=category, query=query)
...
def get_trend_keywords(
    ...
    return trend_service.get_rising_keywords(category=category, limit=limit, job_id=job_id, query=query)
...
def get_trend_timeline(
    ...
    return trend_service.get_timeline(category=category, months=months, job_id=job_id, query=query)
